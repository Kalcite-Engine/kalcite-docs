...
Kalcite is a compiled programming language and lightweight 2D engine for games and applications. Its current source implementation emphasizes explicit costs: no embedded VM, no garbage collector, no hidden allocation, and fixed-capacity game-object pools.
